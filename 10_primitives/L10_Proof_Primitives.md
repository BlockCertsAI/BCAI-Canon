...
- escalate authority  
- permit AI-origin transitions  

Execution MUST always be intentional, constrained, authenticated, and deterministic.
...
Execution errors MUST never partially mutate state.
